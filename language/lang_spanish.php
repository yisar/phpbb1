<?php
/***************************************************************************
 *                           lang_spanish.php  -  description
 *                              -------------------
 *     begin                : Tue Apr 3 2001
 *     copyright            : (C) 2001 by Fernando Najera
 *     email                : yo@fernandonajera.com
 *     based on copyright   : (C) 2001 The phpBB Group
 *              email       : support@phpbb.com
 *
 *     $Id: lang_spanish.php,v 1.2 2001/04/13 06:09:50 thefinn Exp $
 *
 *  ***************************************************************************/
...
$l_enter 	= "Aceptar";
$l_by		= "por"; // Posted by
$l_ondate	= "el"; // This message is edited by: $username on $date
$l_new          = "Nuevos";
...
$l_click 	= "Pulse";
$l_here 	= "aquí";
$l_toreturn	= "para volver";
$l_returnindex	= "$l_toreturn al índice de foros";
$l_returntopic	= "$l_toreturn a la lista de temas del foro.";

$l_error	= "Error";
$l_tryagain	= "Por favor vuelva atrás e inténtelo de nuevo.";
$l_mismatch 	= "Las contraseñas no coinciden.";
$l_userremoved 	= "Este usario ha sido eliminado de la base de datos";
$l_wrongpass	= "La contraseña es incorrecta.";
$l_userpass	= "Por favor proporcione su usuario y contraseña.";
$l_banned 	= "Se le ha bloqueado el acceso a este foro. Si tiene alguna pregunta, contacte con el administrador del sistema.";
...
// Index page
$l_indextitle	= "Indice de Foros";

// Members and profile
$l_profile	= "Perfil";
$l_register	= "Registrarse";
$l_onlyreq 	= "Necesario únicamente si se desea cambiar.";
$l_location 	= "De";
...
$l_website 	= "Dirección de su página Web";
$l_occupation 	= "Ocupación";
$l_interests 	= "Intereses";
$l_signature 	= "Firma";
$l_sigexplain 	= "Este es un bloque de texto que puede añadirse a los mensajes que publique.<BR>Máx. 255 caracteres!";
...
$l_itemsreq	= "Los datos marcados con * son obligatorios";
...
// Private forums
$l_privateforum	= "Este es un <b>Foro Privado</b>.";
$l_private 	= "$l_privateforum<br>Nota: Debe tener las cookies activadas para usar los foros privados.";
$l_noprivatepost = "$l_privateforum No tiene permiso para publicar mensajes en este foro.";
...
$l_viewsite	= "Ir al sitio web de";
$l_icqstatus	= "Estado de $l_icq";  // ICQ status
...
$l_search	= "Buscar";
$l_memberslist	= "Lista de miembros";
$l_faq		= "preguntas";
...
Tenemos -$total_users- ".($total_users==1?"usuario registrado":"usuarios registrados").".<br>
El último usuario registrado ha sido -<a href=\"$profile_url\">$newest_user</a>-.<br>
...
// Register
$l_notfilledin	= "Error - No rellenó todos los datos necesarios.";
...
no podemos recuperarla. Sin embargo, si olvida su contraseña, le podemos generar
...
$email_sig
";
$l_beenadded	= "Sus datos ya están actualizados en nuestra base de datos.";
$l_thankregister= "¡Gracias por registrarse!";
$l_useruniq	= "Debe ser único. Dos usuarios no pueden tener el mismo nombre de usuario.";
$l_storecookie	= "Almacenar mi nombre de usuario en este ordenador durante 1 año (usando una cookie).";

// Prefs
$l_prefupdated	= "$l_preferences actualizadas. $l_click <a href=\"index.$phpEx\">$l_here</a> $l_returnindex";
$l_editprefs	= "Editar sus $l_preferences";
$l_themecookie	= "NOTA: Para usar esquemas de colores DEBE tener las cookies activadas.";
$l_alwayssig	= "Siempre incluir mi firma";
$l_alwaysdisable= "Siempre desactivar"; // Only used for next three strings
$l_alwayssmile	= "$l_alwaysdisable $l_smilies";
$l_alwayshtml	= "$l_alwaysdisable $l_html";
$l_alwaysbbcode	= "$l_alwaysdisable $l_bbcode";
$l_boardtheme	= "Esquemas de Colores de los Foros";
$l_boardlang    = "Idioma de los Foros";
$l_nothemes	= "No existen esquemas de colores registrados";
$l_saveprefs	= "Guardar $l_preferences";

// Search
$l_searchterms	= "Palabras claves";
$l_searchany	= "Buscar CUALQUIERA de los términos (Valor por defecto)";
...
$l_search	= "Buscar";
$l_nomatches	= "No hay registros que coincidan con sus criterios. Amplíe los criterios de búsqueda";
...
O puede ir directamente al indice de los foros en:
...
$l_cansend	= "pueden enviar $l_privmsgs";  // All registered users can send PM's
...
// Delpmsg
$l_deletesucces	= "Borrado con éxito.";
...
$l_passchange	= "Su contraseña ha sido cambiada con éxito. Ahora puede ir a su <a href=\"bb_profile.$phpEx?mode=edit\">perfil</a> y cambiarla por una más adecuada.";
$l_wrongmail	= "La dirección de correo electrónica que proporcionó no coincide con la almacenada en su registro.";
...
$l_passsent	= "Su contraseña ha sido cambiada por una nueva generada al azar. Por favor revise su correo electrónico para obtener la información de cómo completar el proceso de cambio".
