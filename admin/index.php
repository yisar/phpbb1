...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_forums.php?mode=addforum">Add a Forum</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_forums.php?mode=editforum">Edit a Forum</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_priv_forums.php?mode=editforum">Set Private Forum Permissions</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_board.php?mode=sync">Sync forum/topic index</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_forums.php?mode=addcat">Add a Category</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_forums.php?mode=editcat">Edit a Category Title</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
     <TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_forums.php?mode=remcat">Remove a Category</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
     <TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_forums.php?mode=catorder">Re-Order Categories</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_board.php?mode=setoptions">Set Forum-wide Options</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_board.php?mode=rankadmin">Create/Edit User Rankings</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_board.php?mode=headermetafooter">Set Header/Meta/Footer</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_users.php?mode=moduser">Modify User</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_users.php?mode=remuser">Remove a User</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_users.php?mode=banuser">Ban a User</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
       	<TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_users.php?mode=badusernames">Disallow a Username</a></FONT></TD>
...
<TR BGCOLOR="<?php echo $color2?>" ALIGN="LEFT">
     <TD><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><a href="<?php echo $url_admin?>/admin_users.php?mode=badwords">Censor Bad Words</a></FONT></TD>
